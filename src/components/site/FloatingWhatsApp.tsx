...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="pulse-gold fixed right-5 bottom-5 z-50 grid h-14 w-14 place-items-center rounded-full bg-[image:var(--gradient-gold)] shadow-[var(--shadow-lift)] transition-transform duration-300 hover:scale-110 sm:right-8 sm:bottom-8 sm:h-16 sm:w-16"
    >
